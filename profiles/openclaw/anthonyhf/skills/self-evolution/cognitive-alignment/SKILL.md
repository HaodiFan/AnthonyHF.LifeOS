...
description: Handle AnthonyHF cognitive alignment, disagreement review, and reusable lesson routing.
source_runtime: openclaw
canonical_source: skills/self-evolution/cognitive-alignment/SKILL.md
---
...
- `skills/self-evolution/cognitive-alignment/SKILL.md`
