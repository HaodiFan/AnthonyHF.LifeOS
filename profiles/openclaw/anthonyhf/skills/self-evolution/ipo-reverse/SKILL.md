---
name: anthonyhf-ipo-reverse
description: Reverse-engineer finished outputs into evidence maps, hidden cognitive tasks, middle-layer assets, and reusable IPO.
source_runtime: openclaw
canonical_source: skills/self-evolution/ipo-reverse/SKILL.md
---
...
- `skills/self-evolution/ipo-reverse/SKILL.md`
