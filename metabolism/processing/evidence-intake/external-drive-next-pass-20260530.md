...
- `metabolism/processing/evidence-intake/external-drive-project-first-read-20260530.md`
...
| Public homepage / product presentation surfaces | public narrative and productization evidence | `identity/wenxin/`, `work/apps/homepage/` if public-safe |
...
| Marketplace / data product experiments | productization and GTM direction | `identity/wenxin/`, `runtime/memory/working-lessons/` |
...
- `runtime/memory/working-lessons/` for provisional lessons before promotion
...
- `work/apps/homepage/` only for owner-approved public assets
