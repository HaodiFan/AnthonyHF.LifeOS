...
const topRoutes: RouteItem[] = [
  ...
  },
  {
    ...
    href: `${repo}/blob/main/identity/memories/wiki-repo.yml`,
    icon: Brain,
  },
];
...
const networkRoutes: RouteItem[] = [
  ...
  },
  {
    ...
    title: 'AnthonyHF.LifeOS',
    copy: '当前样板间。人读 profile，AI 读 protocol，runtime 读 projection。',
    href: homepage,
    icon: Sparkles,
  },
  {
  ...
  return (
    <>
      <header className="fixed left-0 right-0 top-0 z-50 flex min-h-14 items-center justify-between gap-4 border-b border-white/10 bg-[#06111d]/70 px-4 text-white backdrop-blur-xl md:px-8">
        <ExternalAnchor href={homepage} className="flex items-center gap-3">
          ...
          <span className="hidden text-sm font-semibold sm:block">AnthonyHF.LifeOS</span>
        </ExternalAnchor>
      ...
      <FlowArt aria-label="AnthonyHF.LifeOS public story scroll">
        <FlowSection
          aria-label="AnthonyHF.LifeOS hero"
          style={{
            background:
          ...
          <div className="grid min-h-0 flex-1 items-center gap-6 lg:grid-cols-[0.95fr_1.05fr]">
            <div className="max-w-3xl">
              ...
              <p className="mt-5 max-w-[58ch] text-[clamp(1rem,2vw,1.45rem)] leading-relaxed text-white/78">
                一个给人、AI 和 agent runtime 共用的公开入口：人看见 Anthony Fan 的能力结构，AI 读到协作协议、长期记忆和公开边界，OpenClaw/Hermes 读取生成投影。
              </p>
            ...
            <div className="relative mx-auto w-full max-w-[820px]">
              ...
              <img
                ...
                alt="AnthonyHF.LifeOS digital avatar interface map"
          ...
          <div className="grid flex-1 items-center gap-6 lg:grid-cols-[0.9fr_1.1fr]">
            ...
            <div>
              ...
              <p className="mt-5 max-w-[58ch] text-[clamp(1rem,1.8vw,1.28rem)] leading-relaxed text-[#385165]">
                AnthonyHF.LifeOS 把公开身份、工程判断、长期记忆、安全边界和 runtime projection 放进同一个结构里。它的目标不是包装个人品牌，而是让人、AI 和不同 agent runtime 更准确地进入上下文。
              </p>
            </div>
          </div>
        ...
        >
          <div className="mt-12 flex items-center justify-between text-xs text-white/56">
            ...
            <span className="font-mono uppercase">homepage path: apps/homepage/components/ui</span>
          </div>
          ...
          <div className="grid grid-cols-2 gap-2 sm:grid-cols-5">
            ...
            <LogoTile src={asset('assets/shared/snapanthony.png')} alt="SnapAnthony logo" />
            <LogoTile src={asset('assets/shared/shellprobe.jpg')} alt="ShellProbe logo" />
          </div>
        </FlowSection>
        ...
        >
          ...
          <div className="hidden gap-3 2xl:grid 2xl:grid-cols-[1fr_1fr_1.2fr]">
            <div className="rounded-lg border border-white/12 bg-white/[0.055] p-3">
              <img
                src={asset('assets/shared/snapanthony.png')}
            ...
            <div className="rounded-lg border border-white/12 bg-white/[0.055] p-3">
              <img
                src={asset('assets/shared/shellprobe.jpg')}
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-white/62">
                    Vite build 输出静态文件；`base` 已设为 `/AnthonyHF.LifeOS/`，可以部署到 `gh-pages` 分支。
                  </p>
                </div>
              </div>
            </div>
