...
The homepage is now a Vite React page using GSAP ScrollTrigger through `work/apps/homepage/components/ui/story-scroll.tsx`. It should feel like a precise scrollable system poster rather than a generic personal landing page. Visual density is acceptable when it improves routing clarity.
...
- **Do** keep useful public static assets in `work/apps/homepage/public/assets/` with provenance notes.
