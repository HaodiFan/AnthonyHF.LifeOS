...
4. **工作/生活记忆**：先读 `memory/af-wiki/START-HERE.md`，再读 `memory/af-wiki/areas/index.md`，最后进入目标 area 的 `SCHEMA.md`。
5. **工程方法论**：当任务涉及项目、架构、执行、验证、SOP、AI/Agent workflow、review 或工程判断时，读取 `skills/engineering-everything/engineering-everything/SKILL.md`。
6. **安全边界**：涉及公开/私密材料判断时，读取 `security/README.md`。
